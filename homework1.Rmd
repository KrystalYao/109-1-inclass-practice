...
Game5<-list( Date="Oct. 9",StartTime="21:00",TimeZone="ET",Away="L.A. Lakers",Home="Miami Heat" )
 Game6<-list( Date="Oct. 6",StartTime="21:00",TimeZone="ET",Away=" Miami Heat",Home="L.A. Lakers")
 Game7<-list( Date="Oct. 13",StartTime="19:30",TimeZone="ET",Away="L.A. Lakers",Home=" Miami Heat")


NBA1920Final567<-
list(Game5,Game6,Game7)
print(NBA1920Final567)

names(Game5) # 每個元素名稱
length(Game5) # 元素個數
str(Game5, 1) # 第一層基本元素架構
# NBA1920Final567
```
```
...
exampleList$Date$StartTime$Timezone
